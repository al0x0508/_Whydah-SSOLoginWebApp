...
public class SSOLoginController {
    ...
    public String welcome(HttpServletRequest request, HttpServletResponse response,Model model) {
        ...
        if (userTicket != null && userTicket.length() > 3) {
            ...
            model.addAttribute(UserTokenHandler.REALNAME, XpathHelper.getRealName(userToken));
            model.addAttribute(UserTokenHandler.USER_TOKEN_ID, XpathHelper.getUserTokenId(userToken) );
            return "welcome";
        }
